...
class VerifyResNetHypotheses(Experiment):
    ...
    def __init__(self, args=None):
        ...
        self.class_latent_space_size = 25
        """ (int) Latent space size. """

        self.data_latent_space_size = 25
        """ (int) Latent space size. """

        decoder_file = 'Manifolds/CelebA/vaegan2_%d_%d_abs_30_64_64_%g_%g_0_manual/decoder'
        encoder_file = 'Manifolds/CelebA/vaegan2_%d_%d_abs_30_64_64_%g_%g_0_manual/encoder'
        ...
        self.manifold_directory = 'Manifolds/CelebA/vaegan2'
        ...
        self.off_training_options = OffAttackMadryLInfOptions(self.off_training_epsilon, self.max_iterations)
        ...
        for epsilon in self.on_attack_epsilons:
            ...
            self.stn_attack_options += [
                STNAttackMadryLInfOptions(epsilon, self.max_iterations, self.stn_N_theta, self.stn_translation, self.stn_shear, self.stn_scale,
                                          self.stn_rotation),
            ]
    ...
    def network_parameters(self):
        ...
        if self.network_architecture is None:
            self.network_architecture = [
                ...
                '-network_channels=64',
                '-network_units=3,3,3', # blocks for resnet20
            ]
    ...
    def experiment(self):
        ...
        return 'VerifyResNetHypotheses/CelebA/'
