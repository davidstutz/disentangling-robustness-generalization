...
class VerifyMLPHypotheses(Experiment):
    """
    ...
    def __init__(self, args=None):
        ...
        super(VerifyMLPHypotheses, self).__init__(args)
    ...
    def get_parser(self):
        ...
        parser = super(VerifyMLPHypotheses, self).get_parser()
    ...
    def experiment(self):
        ...
        return 'VerifyMLPHypotheses/Fonts/%s/' % self.args.suffix
