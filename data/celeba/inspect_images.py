...
class InspectDataset:
    ...
    def get_parser(self):
        ...
        parser.add_argument('-images_file', default=paths.celeba_train_images_file(), type=str)
        parser.add_argument('-output_directory', default='/BS/dstutz/work/data/CelebA/_CelebA/', type=str)
