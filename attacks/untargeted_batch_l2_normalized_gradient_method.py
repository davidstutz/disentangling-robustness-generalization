...
class UntargetedBatchL2NormalizedGradientMethod(UntargetedBatchNormalizedGradientMethod):
    """
    ...
    def __init__(self, model, images, classes=None, epsilon=0.5, base_lr=0.01, max_iterations=500):
        ...
        super(UntargetedBatchL2NormalizedGradientMethod, self).__init__(model, images, classes, epsilon, base_lr, max_iterations)
    ...
    def normalize(self):
        ...
        norm = torch.norm(self.gradients.view(self.gradients.size()[0], -1), 2, 1)
