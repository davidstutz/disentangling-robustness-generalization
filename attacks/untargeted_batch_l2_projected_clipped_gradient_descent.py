...
class UntargetedBatchL2ProjectedClippedGradientDescent(UntargetedBatchL2GradientDescent):
    """
    ...
    def __init__(self, model, images, classes=None, epsilon=0.5, c=0.05, base_lr=0.1, max_projections=5):
        ...
        super(UntargetedBatchL2ProjectedClippedGradientDescent, self).__init__(model, images, classes, epsilon, 0.0, c, base_lr)
