...
class TrainSTNClassifierAdversarially2(train_stn_classifier_adversarially.TrainSTNClassifierAdversarially):
    """
    Train a classifier.
    ...
    def __init__(self, args=None):
        ...
        super(TrainSTNClassifierAdversarially2, self).__init__(args)
    ...
    def get_parser(self):
        ...
        parser.add_argument('-decoder_attack', default='UntargetedBatchL2ClippedGradientDescent', help='Attack to try.', type=str)
        parser.add_argument('-decoder_objective', default='UntargetedF6', help='Objective to use.', type=str)
    ...
    def train(self):
        ...
        for b in range(num_batches):
            ...
            if self.args.full_variant:
                ...
                self.decoder_classifier.decoder.set_image(batch_images[split:])
                ...
                self.decoder_classifier.decoder.set_image(batch_images[:split//2])
    ...
    def test(self):
        ...
        for b in range(num_batches):
            ...
            objective = self.objective_class()
            self.decoder_classifier.decoder.set_image(batch_images)
...
if __name__ == '__main__':
    program = TrainSTNClassifierAdversarially2()
    program.main()