...
class TrainLearnedDecoderClassifierAugmented(train_learned_decoder_classifier_adversarially.TrainLearnedDecoderClassifierAdversarially):
    """
    Train a classifier.
    ...
    def __init__(self, args=None):
        ...
        super(TrainLearnedDecoderClassifierAugmented, self).__init__(args)
...
if __name__ == '__main__':
    program = TrainLearnedDecoderClassifierAugmented()
    program.main()